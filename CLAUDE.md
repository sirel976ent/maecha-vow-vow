...
> Le CLAUDE.md parent (`/home/sirel/docker/openclaw-raya/CLAUDE.md`) decrit RAYA, ses skills et ses regles generales. Lis-le en premier. Ce fichier-ci couvre uniquement ce qui est **specifique au dossier Maecha_VowVow**.
